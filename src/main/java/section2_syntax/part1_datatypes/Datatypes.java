...
public class Datatypes {
    ...
    */
    ...
    String modifyString() {
        ...
        return replaceWord(input, "coffee", "soda");
    }
    ...
    String[] getFirstAndLastAsStringRepresentation(Object[] input) {
        ...
        myArr[0] = input[0].toString();
        myArr[1] = input[input.length - 1].toString();
        return myArr;
    }
    ...
    int[] cubeAll(int[] input) {
        ...
        int[] cube = new int[arrayLength];
        for(int i = 0; i < arrayLength; i++) {
            //YOUR ITERATION CODE HERE
            cube[i] = (int)Math.pow(input[i], 3);
        }
        return cube;
    }
